...
\begin{itemize}
    ...
    \item Generated OpenAPI specification (see \Cref{sec:openapi}) for implemented REST API is available in the \texttt{openapi.json} file. The specification can be tested in Swagger UI (available at \url{https://editor.swagger.io/} for example).
\end{itemize}
