...
\thesissetup{
    ...
    abstract    = {%
      ...
      This paper first introduces the Shongo system and discusses the necessary change in its architecture. After the comment about the technologies used, the proposed implementation is presented and the resulting API is described.
    },
    thanks      = {%
