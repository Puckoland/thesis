...
It allows administrators to define available videoconferencing resources (e.g., Pexip or Adobe Connect Server) and users to request a reservation for the available resources.
