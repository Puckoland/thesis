...
Architecture 
The system is composed of a few separate modules. Their interconnections are shown in \Cref{fig:architecture}.
...
\scalegraphics{assets/architecture}{Shongo architecture}{architecture}
